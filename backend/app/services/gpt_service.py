...
{{
  ...
  "growth_areas": ["КОНКРЕТНЫЕ рекомендации менеджеру: что именно исправить в привязке к невыполненным критериям. Каждая рекомендация должна содержать: (1) что не так, (2) как исправить, (3) пример фразы или техники. Минимум по одной рекомендации на каждый критерий с оценкой 0 или 0.5."],
